...
- Money-based platforms create inequality
- Trust and payment disputes are common
...
- Everything stays within the local community
...
3. Sends or receives skill requests
4. Skill exchange happens (online for Now)
5. Credits are updated after mutual confirmation
...
- Local/community-based matching
